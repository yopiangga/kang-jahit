...
export function CariOrder() {
  ...
  const handleDetail = (id) => {
    ...
    axios
      .get(`${url.api}user/${orders[id]?.id_konveksi}`)
      .then((res) => {
              ...
              <div className="px-6">
                          ...
                          <div className="flex items-center">
                            <div className="flex flex-col">
                              ...
                              <div className="flex-auto text-gray-800 my-1">
                                <span className="mr-3 ">
                                  {konveksi?.konveksi?.nama_konveksi}
                                </span>
                ...
                <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                  ...
                  {validasiTawar() ? (
                    <button
                      onClick={handleTawar}
                      className="py-2 w-48 transition-colors duration-700 transform bg-indigo-500 hover:bg-blue-400 text-gray-100 text-md focus:border-4 border-indigo-300"
                    >
                      Tawarkan Jasa
                    </button>
                  ) : (
