                                ...
                                <div className="w-full px-4 text-center mt-32">
                                    <div className="flex justify-center py-4 lg:pt-4 pt-8">
                                        <div className="mr-4 p-3 text-center">
                                            ...
                                            <span className="text-sm text-blueGray-400">Pengajuan Masuk</span>
                                        </div>
                                        <div className="mr-4 p-3 text-center">
                                            <span className="text-xl font-bold block uppercase tracking-wide text-blueGray-600">
                                                10
                                            </span>
                                            <span className="text-sm text-blueGray-400">Pengajuan Ditolak</span>
                                        </div>
                                ...
                                <div className="flex flex-col">
                                    {
                                        [...Array(5)].map(function (el, idx) {
                                            return (
                                                <div className="bg-white border border-gray-100 rounded-lg p-4 m-4">
                                                    <div className="flex-none sm:flex">
                                                        ...
                                                        <div className="flex-auto sm:ml-5 justify-evenly">
                                                            ...
                                                            <div className="flex pt-2 text-sm text-gray-400">
                                                                <button className="flex-no-shrink bg-indigo-400 hover:bg-indigo-500 px-5 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-indigo-300 hover:border-indigo-500 text-white rounded-full transition ease-in duration-300 mr-2">TERIMA</button>
                                                                <button className="flex-no-shrink bg-red-400 hover:bg-red-500 px-5 py-2 text-xs shadow-sm hover:shadow-lg font-medium tracking-wider border-2 border-red-300 hover:border-red-500 text-white rounded-full transition ease-in duration-300">TOLAK</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
